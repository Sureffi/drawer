// octants.go — the 2x4 block glyphs, indexed by their bits.
//
// Generated from the Unicode 16 character names (BLOCK OCTANT-1234 and
// the twenty-six patterns that already had a name in Block Elements and
